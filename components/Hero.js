    ...
    <div className="container mx-auto">
        <div className="row mt-6">
            <div className="col-md-8 mx-auto text-center">
                ...
                <a href="https://github.com/florianheysen/geoloc" target="_blank" rel="noreferrer" className="text-black focus:outline-none focus:ring-4 font-semibold rounded-lg text-sm pl-12 pr-5 py-2.5 mr-2 mb-2 bg-gray-200 hover:bg-gray-300 focus:ring-sky-400 text-center inline-flex items-center">
