      ...
      <div className="row mt-5">
        <div className="mx-auto">
          ...
          <p className="py-4 text-slate-400">
            {lang.How.desc1}{" "}
            <span className="text-slate-100 font-consolas">`geoloc`</span>{" "}
            {lang.How.desc2}
          </p>
        ...
        <div className="mx-auto">
          ...
          <p className="py-4 text-slate-400">{lang.How.text1}</p>
          <div className="code-window">
            <div className="dots">
              <div className="border border-slate-600"></div>
              <div className="border border-slate-600"></div>
        ...
        <div className="mx-auto">
          ...
          <p className="py-4 text-slate-400">{lang.How.text2}</p>
          <div className="code-window">
            <div className="dots">
              <div className="border border-slate-600"></div>
              <div className="border border-slate-600"></div>
          ...
          <div
            className="flex mt-4 p-4 text-sm rounded-lg bg-[#0f172a] text-slate-300"
            role="alert"
          >
            <svg
